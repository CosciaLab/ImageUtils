...
#TODO label channels with the colors used
#TODO naturalsort the files in the directory
#TODO add clip percentage to CLI
#TODO scale dpi according to image size
...
def get_args():
    ...
    inputs.add_argument("-c", "--channels",     dest="channels",    action="store", required=True, type=str, help="Channels to overlay")
...
def main():
    ...
    if file_or_folder == "single_file":
        ...
        #loop through all files in the directory that are tif files
